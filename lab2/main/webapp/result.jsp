            ...
            <tr class="content">
                ...
                <td class="element">
                        ...
                        <script>
                            ...
                            <% ArrayList<ValidPoint> arx = (ArrayList<ValidPoint>) session.getAttribute("points");%>
                            <% for (ValidPoint p : arx) {%>
                                ctx.beginPath();                                  // rectangle in second
                                ctx.rect( <%= p.getX()*180/p.getR() + 225%>, <%=p.getY()*180/p.getR()*(-1) + 200%> , 3, 3);

                                <% if (p.getResult() == "Point hit the area"){%>
            ...
            <thead>
                ...
                <% for (ValidPoint validPoint : validPoints) { %>
                    <tr>
                        ...
                        <td> <%= validPoint.getResult() %> </td>
                        <td> <%= validPoint.getDate() %> </td>
